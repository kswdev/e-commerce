...
class CustomerControllerTest {
    ...
    void getCustomers_returns_active_customer_list() throws Exception {
        // Given
        CustomerEntity customerEntity = customerEntity(1L, "Hong Gildong", 30, CustomerGrade.VIP, false);
    ...
    void getCustomers_returns_multiple_customers_in_order() throws Exception {
        ...
        List<Customer> customers = List.of(
                ...
                customerEntity(3L, "Lee Sunshin", 45, CustomerGrade.VIP, false)).stream()
    ...
    void getCustomers_response_includes_deleted_field() throws Exception {
        // Given
        CustomerEntity customerEntity = customerEntity(1L, "Hong Gildong", 30, CustomerGrade.BASIC, false);
        Customer customer = objectMapper.convertValue(customerEntity, Customer.class);
        Page<Customer> page = new PageImpl<>(List.of(customer));
        given(customerService.findAllByActiveCustomer(any(Pageable.class))).willReturn(page);
